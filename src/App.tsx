...
// --- DATA ---
const paperMetadata = {
  /** Canonical paper title — drives BibTeX and MLA citations. */
  ...
  /** APA sentence-case title (preserves acronyms such as AI). */
  apaTitle: "Frontier AI performance across the business disciplines: A case-grounded benchmark of knowledge work and analytical reasoning",
  ...
  date: "July 2026",
  year: 2026,
  bibtexKey: "patel2026businesscasebench",
  arxivId: "2607.16057",
  arxivPrimaryClass: "cs.CL",
  doi: "10.48550/arXiv.2607.16057",
  fullPaperUrl: "https://arxiv.org/abs/2607.16057"
};
...
const buildBibtexCitation = () => {
  const authors = paperMetadata.authors
    ...
    .join(" and ");
  return `@article{${paperMetadata.bibtexKey},
  title = {${paperMetadata.title}},
  author = {${authors}},
  journal = {arXiv preprint arXiv:${paperMetadata.arxivId}},
  year = {${paperMetadata.year}},
  eprint = {${paperMetadata.arxivId}},
  archivePrefix = {arXiv},
  primaryClass = {${paperMetadata.arxivPrimaryClass}},
  doi = {${paperMetadata.doi}},
  url = {${paperMetadata.fullPaperUrl}}
}`;
};

const buildApaCitation = () =>
  `${formatApaAuthors(paperMetadata.authors)} (${paperMetadata.year}). ${paperMetadata.apaTitle}. arXiv. https://doi.org/${paperMetadata.doi}`;

const buildMlaCitation = () =>
  `${formatMlaAuthors(paperMetadata.authors)} "${paperMetadata.title}." arXiv, ${paperMetadata.year}, arXiv:${paperMetadata.arxivId}.`;
...
const figures = [
  {
    ...
    caption: "Figure 1: Evaluation pipeline used to construct and score BusinessCaseBench. Case narratives and open-ended questions are paired with reference solutions from instructor case solutions, converted into equally-weighted checklist rubrics, answered by frontier models, and scored criterion by criterion with an LLM-as-judge. Human annotators with business school grading experience validate automatic rubrics and grading on a stratified sample.",
    abbrevCaption: "Figure 1: BusinessCaseBench evaluation pipeline."
  },
  {
    id: "fig-scores",
    src: "/figures/complete_answer_vs_standard_score_by_discipline.png",
    caption: "Figure 2: Frontier model performance under Standard scoring (partial credit) and Complete Answer scoring (every rubric criterion satisfied) on all 615 BusinessCaseBench questions. Partial credit scores are high. Full rubric satisfaction is much lower and varies sharply by discipline."
  },
  {
    id: "fig-trajectory",
    src: "/figures/openai_model_family_trajectory_over_time.png",
    caption: "Figure 3: Within-family trajectory for four OpenAI models over roughly two years on the fixed 615-question BusinessCaseBench, under Standard and Complete Answer scoring and by question-type strata."
  },
  {
    id: "fig-iwa",
    src: "/figures/iwa_performance_heatmap.png",
    caption: "Figure 4: Mean Standard scores by O*NET Intermediate Work Activity on BusinessCaseBench. Each cell is an IWA with at least three questions. Open-ended advisory and opportunity-identification activities rank among the hardest; structured analytical tasks approach ceiling performance."
  },
  {
    id: "fig-strata",
    src: "/figures/sfig_question_type_strata_standard_vs_complete_scoring.png",
    caption: "Figure 5: BusinessCaseBench performance by question-type strata (fictional vs. real cases; numerical vs. non-numerical; subjective vs. objective). Gaps are narrow relative to variation across business disciplines."
  },
  {
    id: "fig-fiction",
    src: "/figures/sfig_fiction_vs_real_performance_delta_by_discipline.png",
    caption: "Figure 6: Within-discipline gap on BusinessCaseBench (mean score on fictional minus real case questions) under Standard scoring, for disciplines with at least five questions in each arm. Positive bars mean higher scores on fiction; most disciplines show small fictional advantages or near parity, while Finance is a pronounced negative outlier (fiction far below real)."
  },
  {
    id: "fig-onet",
    src: "/figures/sfig_ai_impact_on_onet_occupations.png",
    caption: "Figure 7: Implied AI impact on O*NET occupations from BusinessCaseBench, grouped by how thoroughly benchmark questions cover each job's relevant work activities."
  },
  {
    id: "fig-openai-trajectory-discipline",
    src: "/figures/sfig_openai_trajectory_by_discipline.png",
    caption: "Figure 8: Discipline-level OpenAI model family trajectories on BusinessCaseBench (twelve disciplines with n ≥ 15 questions). Panel A: Standard scoring by model; lines highlight the three largest and three smallest discipline-level gains from GPT-4 Turbo to GPT-5.4. Panel B: Complete Answer scoring for the same disciplines. Every tracked discipline improves under both metrics, but gain magnitudes and terminal levels differ."
  }
];
...
const references = [
  ...
  { id: "ref8", text: "Anthropic. (2026, June). Redeploying Claude Fable 5. https://www.anthropic.com/news/redeploying-fable-5." }
];

const overallMetadataRows = [
  { strata: "All questions", n: 615 },
  { strata: "Fictional case", n: 245 },
  { strata: "Real case", n: 370 },
  { strata: "Numerical", n: 184 },
  { strata: "Non-numerical", n: 431 },
  { strata: "Subjective", n: 339 },
  { strata: "Objective", n: 276 },
];
...
const disciplineCompositionRows = [
  ...
  { discipline: "Finance", n: 87, fictional: 32, real: 55, numerical: 64, nonNumerical: 23, subjective: 28, objective: 59 },
  { discipline: "Accounting", n: 58, fictional: 39, real: 19, numerical: 45, nonNumerical: 13, subjective: 9, objective: 49 },
  ...
  { discipline: "Operations & Service Management", n: 31, fictional: 7, real: 24, numerical: 7, nonNumerical: 24, subjective: 12, objective: 19 },
...
const disciplineCompositionTotal = {
  discipline: "Total", n: 615, fictional: 245, real: 370, numerical: 184, nonNumerical: 431, subjective: 339, objective: 276,
};
...
const tocItems = [
  ...
  { id: "fable-5", title: "How does Claude Fable 5 perform?" },
...
const ViewFullPaperButton = ({
  ...
  >
    ...
    {variant === "short" ? "Read the full paper →" : "Read the full paper on arXiv →"}
  </a>
);
      ...
      <div className="max-w-[1400px] mx-auto px-6 py-12 flex flex-col lg:flex-row items-start gap-12 lg:gap-20">
        ...
        <main className="flex-1 max-w-3xl lg:max-w-4xl text-lg leading-relaxed text-slate-700">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-lg p-8 shadow-sm">
              ...
              <div className="text-sm md:text-base leading-relaxed text-slate-700 font-serif">
                <ul className="list-none pl-0 m-0 p-0 flex flex-col gap-3">
                  ...
                  <li className="flex items-start gap-4">
                    <Sparkles className="w-3.5 h-3.5 md:w-4 md:h-4 text-amber-500 shrink-0 mt-1" />
                    <span>We construct <strong>BusinessCaseBench</strong>: <HighlightLink href="#fig-pipeline">615 open-ended questions</HighlightLink> from <HighlightLink href="#fig-pipeline">238 business school cases</HighlightLink> spanning <HighlightLink href="#tab-by-discipline">18 disciplines</HighlightLink>, graded against expert-written instructor case solutions.</span>
                  </li>
                  <li className="flex items-start gap-4">
                    <Sparkles className="w-3.5 h-3.5 md:w-4 md:h-4 text-amber-500 shrink-0 mt-1" />
                  ...
                  <li className="flex items-start gap-4">
                    <Sparkles className="w-3.5 h-3.5 md:w-4 md:h-4 text-amber-500 shrink-0 mt-1" />
                    <span>Over the last two years, performance rose roughly <HighlightLink href="#fig-trajectory">23 percentage points</HighlightLink> in one model family, with gains across every type of case and question. <HighlightLink href="#fable-5">Claude Fable 5</HighlightLink>, however, scores almost identically to Sonnet 4.6.</span>
                  </li>
                  <li className="flex items-start gap-4">
                    <Sparkles className="w-3.5 h-3.5 md:w-4 md:h-4 text-amber-500 shrink-0 mt-1" />
          ...
          <section id="benchmark" className="scroll-mt-12 mb-16 space-y-6">
            ...
            <p>
              <strong>BusinessCaseBench</strong> comprises <strong>615 open-ended questions</strong> from <strong>238 licensed business school cases</strong> paired with instructor case solutions, spanning <strong>18 disciplines</strong> from Strategy and Finance to Leadership and Operations. It spans subjective and open-ended analytical questions as well as objective, numerical reasoning questions. We classify each question as derived from a case about a fictional firm or a real firm, and as numerical or non-numerical and subjective or objective. The benchmark includes 245 questions on fictional firms and 370 on real firms, 184 numerical and 431 non-numerical questions, and 339 subjective and 276 objective questions. Each question is mapped to the <OnetLink /> occupational taxonomy at Work Activity, Intermediate Work Activity, and Detailed Work Activity levels so results can be read against professional work classifications as well as academic disciplines.
            </p>
            <PullQuote
              citeId="ref3"
              authors="Nohria"
            ...
            <figure id="tab-representative-questions" className="my-12 scroll-mt-24 w-full">
              ...
              <figcaption className="mt-4 w-full text-sm text-slate-500 font-serif leading-relaxed border-l-2 border-wharton/30 pl-4 py-1">
                Table 1: Representative examples from BusinessCaseBench of case questions. Each entry is a representative question summary; full case context accompanies each in evaluation.
              </figcaption>
            </figure>
          ...
          <section id="performance" className="scroll-mt-12 mb-16 space-y-6">
            ...
            <p>
              Across all 615 questions, three frontier models perform at a uniformly high level under Standard scoring. Claude Sonnet 4.6 reaches <strong>88.4%</strong>, GPT-5.4 <strong>87.2%</strong>, and Gemini 3 Flash Preview <strong>81.6%</strong>, a spread of only 6.8 points. When rubric criteria are credited independently, frontier models already cover most of what instructor case solutions expect on open-ended business case work.
            </p>
            <p>
              The same comparison looks materially different under Complete Answer scoring, which requires every rubric criterion on a question to be satisfied. The same models reach full-criterion satisfaction on only <strong>49.6%</strong>, <strong>47.6%</strong>, and <strong>32.0%</strong> of questions respectively. Even the leading model leaves more than half of questions without a fully complete answer by instructor standards. High partial credit therefore describes <em>strong drafts</em> that capture much of the expected analysis, not outputs that meet the full scope of the instructor rubric without review, particularly on subjective, multi-part questions where missing one element is common.
            </p>
            <p>
              Discipline-level performance is structured rather than noisy. Standard scores range from <strong>80.1%</strong> in Marketing &amp; Sales to <strong>95.0%</strong> in Business &amp; Government Relations, a spread larger than the gap among the three models themselves. Under Complete Answer scoring the same disciplines separate more sharply (25.8% in Operations &amp; Service Management to 82.5% in Decision Analysis). All three frontier models rank disciplines in nearly the same order, with high rank concordance (Kendall’s <InlineMath math="W" /> = 0.79 under Standard scoring and 0.89 under Complete Answer scoring), indicating that harder and easier disciplines are ranked similarly across providers rather than reflecting any single provider’s training idiosyncrasies.
            </p>
          ...
          <section id="progress" className="scroll-mt-12 mb-16 space-y-6">
            ...
            <p>
              Holding the benchmark fixed, we evaluated four successive OpenAI releases over roughly two years, from GPT-4 Turbo through GPT-4.1 and GPT-5 to GPT-5.4. Mean Standard score rose from <strong>63.9%</strong> to <strong>87.2%</strong>, a <strong>23.3 percentage-point</strong> gain. Complete Answer scoring moved in parallel, from <strong>13.2%</strong> to <strong>47.6%</strong> (+34.4 points), showing models are improving on thoroughness, not merely earning more partial credit.
            </p>
            <p>
              The gains are broad-based. Fictional and real cases improve by essentially the same margin. Numerical questions gain more in absolute terms, but non-numerical and subjective strata improve as much or more under Complete Answer scoring. That pattern counters a narrative in which progress is only “getting better at math,” the capability early models struggled with and popular suites like MATH measure <RefLink id="ref6">6</RefLink>. Large moves appear in Economics (+31.7 points), Accounting (+28.8), and Finance (+28.7) where GPT-4 Turbo began far below today’s levels.
            </p>
            <p>
          ...
          <section id="difficulty" className="scroll-mt-12 mb-16 space-y-6">
            ...
            <p>
              Broad labels tell you surprisingly little about which questions are hard. Under Standard scoring, mean performance across the six metadata strata sits in a narrow <strong>82.3–87.2%</strong> band, and subjective and objective questions differ by only 0.8 percentage points. Complete Answer scoring widens these gaps modestly but leaves them small relative to the spread across disciplines in <FigureLink id="fig-scores">Figure 2</FigureLink>. A regression of scores on question type and discipline confirms the point: together they explain only about <strong>5%</strong> of the variation in scores. What matters far more is the specific case. Knowing which case a question comes from explains roughly four times as much variation as those labels do, and nearly half of the variation sits between questions within the same case. Difficulty lives in the particulars—longer ambiguous narratives, multi-part rubrics, and more open-ended advisory or evaluative reasoning—rather than in the category a question falls under.
            </p>
            <FigureBlock figureIdx={4} onOpen={openFigure} />
            <p>
              On the full benchmark, questions from real cases score slightly higher than questions from fictional cases under Standard scoring (<strong>86.5%</strong> vs. <strong>84.6%</strong>, a 1.9 percentage-point gap), but the pattern is discipline-specific rather than uniform. In most disciplines with enough questions in both arms, fictional cases score at or above real ones, consistent with real cases having longer and more ambiguous narratives that present more of a challenge than a simplified hypothetical scenario. Finance and Accounting reverse the pattern. Fictional finance questions score <strong>15.0 percentage points</strong> below real finance questions (<strong>70.9%</strong> vs. <strong>85.9%</strong>), with Accounting showing a smaller 2.7-point gap in the same direction; Finance stands out as the lone large negative outlier in <FigureLink id="fig-fiction">Figure 6</FigureLink>. Questions from real cases in these disciplines often anchor on named companies whose financial profiles may appear in public filings or financial press, giving models a pre-training edge that fictional cases, which strip away that exposure, do not provide.
            </p>
            <FigureBlock figureIdx={5} onOpen={openFigure} />
            <p>
              Genuine capability ceilings are rare. Only <strong>43 of 615 questions (7.0%)</strong> score at or below 70% for every frontier model we tested, and only <strong>6.2%</strong> of individual rubric criteria never receive credit from any model. A cross-model oracle that takes the best score per question reaches <strong>92.8%</strong>, 4.5 points above the best single model. What one model misses on a given question is therefore often captured by another, so remaining error reflects incomplete satisfaction of multi-part rubrics more often than absolute capability ceilings.
            </p>
            <p id="onet-mapping" className="scroll-mt-24">
              Mapping benchmark questions to <OnetLink /> Intermediate Work Activities bridges academic disciplines to occupational work activities and occupations <RefLink id="ref4">4</RefLink>. Across 29 IWAs with at least three benchmark questions, mean Standard scores range from <strong>70.9%</strong> on “Identify business or organizational opportunities” to near-ceiling performance on bounded explanatory and mathematical analysis activities. <FigureLink id="fig-iwa">Figure 4</FigureLink> shows that the hardest activities combine open-ended advisory framing with case-specific quantitative or evaluative reasoning. These mappings are indicative rather than definitive. O*NET work activities are broad and only loosely tied to what any single case question tests, so implied occupation-level results in <FigureLink id="fig-iwa">Figure 4</FigureLink> and <FigureLink id="fig-onet">Figure 7</FigureLink> should be read together with how thoroughly each job’s relevant activities appear in the benchmark.
            </p>
            <FigureBlock figureIdx={3} wide onOpen={openFigure} />
          </section>

          <section id="fable-5" className="scroll-mt-12 mb-16 space-y-6">
            <h2 className="text-3xl font-display font-semibold text-slate-900 mb-6">How does Claude Fable 5 perform?</h2>
            <p>
              After the primary experiments above were complete, Anthropic released Claude Fable 5, a Mythos-class model substantially larger than prior public systems and marketed with particular emphasis on software engineering. Deployment was briefly interrupted under U.S. export controls related to cybersecurity concerns <RefLink id="ref8">8</RefLink>. As this release fell near the end of our evaluation period for this research, we report Fable 5 as an after-the-fact result on BusinessCaseBench rather than folding it into the frontier trio in <FigureLink id="fig-scores">Figure 2</FigureLink>.
            </p>
            <p>
              Aggregate performance is nearly indistinguishable from Claude Sonnet 4.6. Under Standard scoring, Fable 5 reaches <strong>88.0%</strong>, compared with <strong>88.4%</strong> for Sonnet 4.6. Under Complete Answer scoring, it reaches <strong>50.9%</strong>, 1.3 points above Sonnet 4.6 at <strong>49.6%</strong>. Confidence intervals overlap on both metrics, and the discipline ordering of harder and easier domains stays intact.
            </p>
            <p>
              That near-parity is notable given how this release class has been framed around agentic software engineering. Fable 5 does not deliver a step change relative to Sonnet 4.6 on BusinessCaseBench. Optimizing for software-engineering workflows does not clearly lift performance on this class of open-ended business knowledge work.
            </p>
          </section>
          ...
          <section id="implications" className="scroll-mt-12 mb-16 space-y-6">
            ...
            <p>
              On BusinessCaseBench, frontier AI already performs well on open-ended business case questions when graded against expert-written standards drawn from instructor case solutions. Capability within at least one model family has improved dramatically over roughly two years. The empirical question is no longer whether models can do the analytic knowledge work cases demand, but how completely they do it, where they remain weakest, and how business schools and firms should respond as that capability redistributes between humans and machines.
            </p>
            <p>
              For business schools, case pedagogy trains the judgment, synthesis, and defensible reasoning that MBA programs and undergraduate curricula were designed to build, skills that have historically anchored early-career analytical work <RefLink id="ref3">3</RefLink>. When strong drafts are inexpensive and fast, programs have to emphasize verification, thoroughness, and knowing what a fully complete answer requires, particularly where Standard scores are already high but Complete Answer satisfaction remains elusive.
            </p>
            <p>
              For labor markets, occupational mappings in <FigureLink id="fig-onet">Figure 7</FigureLink> highlight where entry-level analytical work faces the most implied exposure and where human advantage may persist in integration across stakeholders, accountability, and organizational context that single-turn benchmarks like ours undermeasure. Field evidence on uneven productivity gains across knowledge workers underscores that the frontier is jagged in practice, not smooth <RefLink id="ref7">7</RefLink>.
            </p>
            <FigureBlock figureIdx={6} wide onOpen={openFigure} />
            <p>
              For model development, BusinessCaseBench points to where further progress still matters. As many standard AI benchmarks approach saturation, measuring gains will increasingly require evaluations grounded in economically meaningful knowledge work rather than factual recall, math, or coding alone. Models already produce strong analytical drafts, yet they often omit key considerations, fail to integrate competing constraints, or stop short of a complete recommendation. Those harder cases are a natural target for post-training and related methods that reward synthesis, completeness, trade-off analysis, and judgment under uncertainty.
            </p>
          ...
          <section id="appendix" className="scroll-mt-12 mb-24 space-y-6">
            ...
            <p>
              As a check on judge sensitivity, we also regraded answers from all three models with three potential judge models (Gemini 2.5 Flash, Claude Haiku 4.5, and GPT-5-mini) on all 615 questions. All three judge models produce the same overall ranking, so the choice of LLM judge does not reshape comparative conclusions.
            </p>
            ...
            <p>
              Each <InlineMath math="s_{mj}" /> is a normalized fraction in <InlineMath math="[0,1]" /> (the equally weighted share of rubric criteria satisfied on that question). Throughout the paper we multiply by 100 and report Standard scores as percentages—for example, <InlineMath math="s_{mj}=0.884" /> is reported as 88.4%.
            </p>
            <p>
              The model-level Standard score averages <InlineMath math="s_{mj}" /> over all <InlineMath math="N=615" /> questions and is reported the same way. Complete Answer scoring marks whether every criterion on a question is satisfied, that is, when <InlineMath math="s_{mj}=1" />. Reported uncertainties use bootstrap resampling over questions (500 resamples, 95% percentile intervals).
            </p>
            ...
            <CompositionTableBlock
              ...
              caption="Table 2: BusinessCaseBench composition, overall question-level metadata."
              columns={[
            ...
            <CompositionTableBlock
              ...
              scaleOnOverflow
              caption="Table 3: BusinessCaseBench composition by business discipline. Non-num. = non-numerical."
              columns={[
          ...
          <section id="citation" className="scroll-mt-12 mb-24 space-y-6">
            ...
            <p>
              If you reference this work, please cite our arXiv preprint:
            </p>
            <CitationBlock />
          </section>
        </main>
